...
public class Config {
    ...
    public static String PROJECT_DIR = "/Users/maytinhdibo/Downloads/data/cassandra/";
    public static String[] SOURCE_PATH = {"/Users/maytinhdibo/Downloads/data/cassandra/"};
