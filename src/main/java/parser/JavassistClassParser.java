...
public class JavassistClassParser extends ClassParser {
...
//                        throw err;
    ...
    public ResolvedExtendedGenericType resolveExtendGenericType(JavassistClassDeclaration resolvedClassDeclaration, ResolvedType type) {
    ...
    JavassistClassDeclaration reflectionClass;

    public JavassistClassParser(JavassistClassDeclaration reflectionClass, ProjectParser projectParser) {
